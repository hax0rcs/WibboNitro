export class WiredTriggerLayout
{
    ...
    public static AVATAR_SAYS_COMMAND: number = 15;
    public static AVATAR_CLICK: number = 16;
    public static AVATAR_ACTION: number = 17;
    public static CRHONO: number = 18;
    public static LIFE_ACHIEVED: number = 21;
}
