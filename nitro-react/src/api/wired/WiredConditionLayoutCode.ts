export class WiredConditionlayout
{
    ...
    public static CHRONO_COMPARE: number = 27;
    public static ACTOR_COMPARE_ROTATION: number = 29;
    public static TEAM_HAS_RANK: number = 30;
    public static TEAM_HAS_SCORE: number = 31;
    public static FURNI_ALTITUDE: number = 32;
    public static USER_POSITION: number = 33;
    public static FURNI_HAS_COLOUR: number = 34;
    public static COMPARATOR_NON_ID: number = 36;
    public static HAS_FREEZE: number = 37;
}
