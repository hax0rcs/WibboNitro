...
import { Button, Flex, NitroCardContentView, NitroCardHeaderView, NitroCardView, Slider, Text } from '../../../../common';
            ...
            <NitroCardContentView justifyContent="between">
                ...
                <Flex gap={ 2 }>
                    <Button onClick={ event => SendMessageComposer(new FurnitureStackHeightComposer(objectId, -100)) }>
                        <Text variant='white' small>{ LocalizeText('furniture.above.stack') }</Text>
                    </Button>
                    <Button onClick={ event => SendMessageComposer(new FurnitureStackHeightComposer(objectId, 0)) }>
                    <Text variant='white' small>{ LocalizeText('furniture.floor.level') }</Text>
                    </Button>
                </Flex>
