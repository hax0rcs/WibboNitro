...
export const ChatInputView: FC<{}> = props => 
{
    ...
    const { selectedUsername = '', floodBlocked = false, floodBlockedSeconds = 0, setIsTyping = null, setIsIdle = null, sendChat = null, setChatVal = null, chatVal = '' } = useChatInputWidget();
            ...
            <>
                <div className="nitro-chat-input-container">
                    ...
                    <Flex gap={ 2 } alignItems="center">
                        ...
                        <ColorPicker format="rgb" style={ { background: `linear-gradient(45deg, black, transparent) ${ chatColour }` } } value={ chatColour } onChange={ (e) => updateChatColour(e.value) } />
