...
export const PurseView: FC<{}> = props =>
{
    ...
    const getCurrencyElements = (offset: number, limit: number = -1, seasonal: boolean = false) =>
    {
        ...
        for(const type of types)
        {
            ...
            else elements.push(<><CurrencyView key={type} type={type} amount={purse.activityPoints.get(type)} short={currencyDisplayNumberShort} /><div className="divisor" /></>);
    ...
    return (
        <Column alignItems="end" className="nitro-purse-container" gap={ 1 }>
            <Flex className="nitro-purse rounded p-1" justifyContent='center' alignItems='center' gap={2}>
                <Flex>
