                ...
                <Column center={ !currentOffer } size={ 5 } overflow="hidden">
                    { !currentOffer &&
                        <>
                            ...
                            <Text className="fs-13" center dangerouslySetInnerHTML={ { __html: page.localization.getText(0) } } />
                        </> }
                    { currentOffer &&
                        <>
                            <Flex position="relative" center overflow="hidden" style={ { height: 140 } }>
                            ...
                            <Column grow gap={ 1 }>
                                ...
                                <Text bold>{ currentOffer.localizationName }
                                </Text>
                                <Text bold className="description-furniture">{ currentOffer.product.furnitureData?.description }</Text>
                                <Text grow bold>
                                </Text>
