...
import { WiredTriggerAchievedLifeView } from './WiredTriggerAchievedLifeView';
import { WiredTriggerActionsView } from './WiredTriggerActionsView';
import { WiredTriggerAvatarClickView } from './WiredTriggerAvatarClickView';
import { WiredTriggerAvatarEnterRoomView } from './WiredTriggerAvatarEnterRoomView';
import { WiredTriggerAvatarSayCommandView } from './WiredTriggerAvatarSayCommandView';
...
import { WiredTriggerChronoView } from './WiredTriggerChronoView';
...
export const WiredTriggerLayoutView = (code: number) =>
{
    switch(code)
    {
        ...
        case WiredTriggerLayout.AVATAR_SAYS_COMMAND:
            return <WiredTriggerAvatarSayCommandView />;
        case WiredTriggerLayout.AVATAR_CLICK:
            return <WiredTriggerAvatarClickView />;
        case WiredTriggerLayout.AVATAR_ACTION:
            return <WiredTriggerActionsView />
        case WiredTriggerLayout.CRHONO:
            return <WiredTriggerChronoView />
        case WiredTriggerLayout.LIFE_ACHIEVED:
            return <WiredTriggerAchievedLifeView />    
    }
