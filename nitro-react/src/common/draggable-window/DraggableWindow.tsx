    ...
    useEffect(() =>
    {
        ...
        switch(windowPosition)
        {
            case DraggableWindowPosition.TOP_CENTER:
                ...
                break;
            case DraggableWindowPosition.BOTTOM_CENTER:
                element.style.bottom = 50 + offsetTop + 'px';
                element.style.left = `calc(50vw - ${ (element.offsetWidth / 2 + offsetLeft) }px)`;
                break;
            ...
            break;
            case DraggableWindowPosition.TOP_LEFT_MARGINERING:
                element.style.top = 20 + offsetTop + 'px';
                element.style.left = 20 + offsetLeft + 'px';
            break;
        }
