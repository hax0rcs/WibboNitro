...
export class ColorConverter
{
    ...
    public static rgb2Hex(rgb: string): string
    {
        ...
        const r = parseInt(extracted[1], 10);
        const g = parseInt(extracted[2], 10);
        const b = parseInt(extracted[3], 10);
        return '#' + ColorConverter.get2Hex(r) + ColorConverter.get2Hex(g) + ColorConverter.get2Hex(b);
    }

    public static get2Hex(value: number): string
    {
