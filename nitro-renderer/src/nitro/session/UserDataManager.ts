...
export class UserDataManager extends Disposable
{
    ...
    public updateBanner(roomIndex: number, banner: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
    ...
    public updateLevel(roomIndex: number, level: number): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
    ...
    public updateKissesReceived(roomIndex: number, kissesReceived: number): void
    {
        const userData = this.getUserDataByIndex(roomIndex);

        if(!userData) return;

        userData.kissesReceived = kissesReceived;
    }
