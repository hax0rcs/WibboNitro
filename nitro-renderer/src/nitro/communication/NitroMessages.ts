...
export class NitroMessages implements IMessageConfiguration
{
    ...
    {
        // CUSTOM
        this._events.set(IncomingHeader.YOUTUBE_TV, YoutubeTvEvent);
        this._events.set(IncomingHeader.ADD_CHATLOGS, AddChatlogsEvent);
        this._events.set(IncomingHeader.NOTIF_ALERT, NotifAlertEvent);
        this._events.set(IncomingHeader.NOTIF_TOP, NotifTopEvent);
        this._events.set(IncomingHeader.PLAY_SOUND, PlaySoundEvent);
        this._events.set(IncomingHeader.STOP_SOUND, StopSoundEvent);
        this._events.set(IncomingHeader.RP_STATS, RpStatsEvent);
        this._events.set(IncomingHeader.BUY_ITEMS_LIST, BuyItemsListEvent);
        this._events.set(IncomingHeader.LOAD_INVENTORY_RP, LoadInventoryRpEvent);
        this._events.set(IncomingHeader.ADD_INVENTORY_ITEM_RP, AddInventoryItemRpEvent);
        this._events.set(IncomingHeader.REMOVE_ITEM_INVENTORY_RP, RemoveItemInventoryRpEvent);
        this._events.set(IncomingHeader.RP_TROC_START, RpTrocStartEvent);
        this._events.set(IncomingHeader.RP_TROC_STOP, RpTrocStopEvent);
        this._events.set(IncomingHeader.RP_TROC_ACCEPTE, RpTrocAccepteEvent);
        this._events.set(IncomingHeader.RP_TROC_CONFIRME, RpTrocConfirmeEvent);
        this._events.set(IncomingHeader.RP_TROC_UPDATE_ITEMS, RpTrocUpdateItemsEvent);
        this._events.set(IncomingHeader.BOT_CHOOSE, BotChooseEvent);
        this._events.set(IncomingHeader.MENTION, MentionEvent);
        this._events.set(IncomingHeader.COMMANDS_LIST, ChatCommandsListEvent);
        this._events.set(IncomingHeader.YOUTUBE, YouTubeEvent);
        this._events.set(IncomingHeader.COLORABLE_TILE, ColorableTileEvent);
        this._events.set(IncomingHeader.NOTIFICATION_EVENT, NotificationEventAlertEvent);
        ...
        this._events.set(IncomingHeader.USER_BADGE_REMOVE, BadgeRemovedEvent);
        ...
        this._events.set(IncomingHeader.UNIT_CHAT_AUDIO, RoomUnitChatAudioEvent);
        ...
        this._events.set(IncomingHeader.USER_BANNER, UserBannerEvent);
        this._events.set(IncomingHeader.USER_BANNER_LIST, UserBannerListEvent);
    ...
    {
        // CUSTOM
        this._composers.set(OutgoingHeader.UNIT_CHAT_WHISPER_GROUP, ChatWhisperGroupComposer);
        this._composers.set(OutgoingHeader.SEND_ALERT, SendAlertComposer);
        this._composers.set(OutgoingHeader.EDIT_TV, EditTvComposer);
        this._composers.set(OutgoingHeader.MOVE_AVATAR_KEYBOARD, MoveAvatarKeyboardComposer);
        this._composers.set(OutgoingHeader.RP_BUY_ITEMS, RpBuyItemsComposer);
        this._composers.set(OutgoingHeader.RP_USE_ITEMS, RpUseItemComposer);
        this._composers.set(OutgoingHeader.RP_TROC_ADD_ITEM, RpTrocAddItemComposer);
        this._composers.set(OutgoingHeader.RP_TROC_REMOVE_ITEM, RpTrocRemoveItemComposer);
        this._composers.set(OutgoingHeader.RP_TROC_ACCEPTE, RpTrocAccepteComposer);
        this._composers.set(OutgoingHeader.RP_TROC_CONFIRME, RpTrocConfirmeComposer);
        this._composers.set(OutgoingHeader.RP_TROC_STOP, RpTrocStopComposer);
        this._composers.set(OutgoingHeader.BOT_CHOOSE, BotChooseComposer);
        this._composers.set(OutgoingHeader.USER_KISS, KissUserComposer);
        this._composers.set(OutgoingHeader.GIVE_STAR, GiveStarComposer);
        this._composers.set(OutgoingHeader.SAVE_COLORABLE, SaveColorableTileComposer);
        ...
        this._composers.set(OutgoingHeader.DELETE_BADGE_INVENTORY, DeleteBadgeInventoryComposer);

        // BOTS
        this._composers.set(OutgoingHeader.USER_BOTS, GetBotInventoryComposer);

        // FURNI
        this._composers.set(OutgoingHeader.DELETE_FURNITURE_TYPE_INVENTORY, DeleteFurniTypeInventoryComposer);
        ...
        this._composers.set(OutgoingHeader.UNIT_CHAT_AUDIO, RoomUnitChatAudioComposer);
        ...
        this._composers.set(OutgoingHeader.USER_BANNER, UserBannerComposer);
        this._composers.set(OutgoingHeader.USER_BANNER_SELECT, UserBannerSelectComposer);
