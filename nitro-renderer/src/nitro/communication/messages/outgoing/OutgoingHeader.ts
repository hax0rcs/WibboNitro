export class OutgoingHeader
{
    ...
    public static UNIT_CHAT_WHISPER_GROUP = 1118;
    public static SEND_ALERT = 10002;
    public static EDIT_TV = 10003;
    public static MOVE_AVATAR_KEYBOARD = 10006;
    public static RP_BUY_ITEMS = 10008;
    public static RP_USE_ITEMS = 10009;
    public static RP_TROC_ADD_ITEM = 10011;
    public static RP_TROC_REMOVE_ITEM = 10012;
    public static RP_TROC_ACCEPTE = 10013;
    public static RP_TROC_CONFIRME = 10014;
    public static RP_TROC_STOP = 10015;
    public static BOT_CHOOSE = 10016;
    public static FURNITURE_PICKUP_ALL = 10017;
    public static DELETE_FURNITURE_TYPE_INVENTORY = 10018;
    ...
    public static USER_KISS = 10023;
    public static GIVE_STAR = 10024;
    public static SAVE_COLORABLE = 10027;
}
